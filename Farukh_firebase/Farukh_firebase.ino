...
void handleSave() {
  // Connect to Firebase
server.send(200, "text/plain", "Wi-Fi credentials saved and connected tonetwork.");
Serial.println("Connected To WiF i");
...
void loop() {
  ...
  if (wificonnect) {
    ...
    if (fireStatus == 1 && ledstatus == 0) {  // compare the input of led status received from firebase
