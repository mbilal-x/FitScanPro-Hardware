...
void loop()
{
    ...
    if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
    {
        ...
        content.set("values/[0]/mapValue/fields/height/stringValue", "item" + String(count));
        content.set("values/[0]/mapValue/fields/weight/stringValue",  "item" + String(count));
        content.set("values/[0]/mapValue/fields/bmi/stringValue",  "item" + String(count));
        content.set("values/[0]/mapValue/fields/timeStamp/stringValue",  "item" + String(count));
